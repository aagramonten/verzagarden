    ...
    <div style="max-width:1100px;margin:0 auto;padding:20px 16px 60px;">
      ...
      <div *ngIf="activeTab === 'dashboard'">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(110px,1fr));gap:11px;margin-bottom:14px;">
          <div class="metric-card clickable" (click)="setTab('inventario')" title="Ver inventario">
          ...
          <div class="metric-card clickable" style="border-color:#fef3c7;" (click)="setTab('inventario')" title="Ver bajo stock">
            <div style="display:flex;justify-content:center;margin-bottom:8px;">
          ...
          <div class="metric-card clickable" style="border-color:#fee2e2;" (click)="setTab('inventario')" title="Ver sin stock">
            <div style="display:flex;justify-content:center;margin-bottom:8px;">
          ...
          <div class="metric-card clickable" style="background:linear-gradient(135deg,#102319,#1f7a4d);border:none;" (click)="setTab('ventas')" title="Ver ventas">
            <div style="display:flex;justify-content:center;margin-bottom:8px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;margin-top:14px;">
          <button (click)="setTab('ventas')" style="background:white;border:1px solid #eef1ec;border-radius:16px;padding:16px;cursor:pointer;text-align:left;transition:all 0.15s;display:flex;align-items:center;gap:10px;" onmouseover="this.style.borderColor='#14452F'" onmouseout="this.style.borderColor='#eef1ec'">
            <div style="background:#f0fdf4;border-radius:10px;padding:8px;flex-shrink:0;">
              <i data-lucide="bar-chart-2" style="width:18px;height:18px;color:#14452F;"></i>
            </div>
            <div>
              <div style="font-weight:700;color:#102319;font-size:0.85rem;">Ver ventas</div>
              <div style="font-size:0.72rem;color:#9ca3af;">Reporte POS</div>
            </div>
          </button>
          <button (click)="setTab('inventario')" style="background:white;border:1px solid #eef1ec;border-radius:16px;padding:16px;cursor:pointer;text-align:left;transition:all 0.15s;display:flex;align-items:center;gap:10px;" onmouseover="this.style.borderColor='#14452F'" onmouseout="this.style.borderColor='#eef1ec'">
            <div style="background:#f0fdf4;border-radius:10px;padding:8px;flex-shrink:0;">
              <i data-lucide="package" style="width:18px;height:18px;color:#14452F;"></i>
            </div>
            <div>
              <div style="font-weight:700;color:#102319;font-size:0.85rem;">Inventario</div>
              <div style="font-size:0.72rem;color:#9ca3af;">{{ plants.length }} plantas</div>
            </div>
          </button>
          <button (click)="setTab('pos')" style="background:white;border:1px solid #eef1ec;border-radius:16px;padding:16px;cursor:pointer;text-align:left;transition:all 0.15s;display:flex;align-items:center;gap:10px;" onmouseover="this.style.borderColor='#14452F'" onmouseout="this.style.borderColor='#eef1ec'">
            <div style="background:#f0fdf4;border-radius:10px;padding:8px;flex-shrink:0;">
              <i data-lucide="upload" style="width:18px;height:18px;color:#14452F;"></i>
            </div>
            <div>
              <div style="font-weight:700;color:#102319;font-size:0.85rem;">Importar POS</div>
              <div style="font-size:0.72rem;color:#9ca3af;">Subir ventas</div>
            </div>
          </button>
          <button (click)="setTab('inventario'); showForm = true" style="background:#14452F;border:none;border-radius:16px;padding:16px;cursor:pointer;text-align:left;display:flex;align-items:center;gap:10px;">
            <div style="background:rgba(255,255,255,0.15);border-radius:10px;padding:8px;flex-shrink:0;">
              <i data-lucide="plus-circle" style="width:18px;height:18px;color:white;"></i>
            </div>
            <div>
              <div style="font-weight:700;color:white;font-size:0.85rem;">Nueva planta</div>
              <div style="font-size:0.72rem;color:rgba(255,255,255,0.6);">Agregar al catálogo</div>
            </div>
          </button>
        </div>
      </div>
              ...
              <div style="display:flex;flex-direction:column;gap:8px;">
                <div *ngFor="let day of getDailySummary()" style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:#f9fdf9;border-radius:12px;border:1px solid #eef1ec;flex-wrap:wrap;gap:8px;">
                  ...
                  <div style="display:flex;gap:20px;flex-wrap:wrap;">
                    <div style="text-align:center;"><div style="font-size:0.68rem;color:#9ca3af;font-weight:600;text-transform:uppercase;">Unidades</div><div style="font-weight:700;color:#102319;font-size:0.95rem;">{{ day.units }}</div></div>
                    <div style="text-align:center;"><div style="font-size:0.68rem;color:#9ca3af;font-weight:600;text-transform:uppercase;">Ingresos</div><div style="font-weight:700;color:#15803d;font-size:0.95rem;">\${{ day.revenue | number:'1.0-0' }}</div></div>
                    <div style="text-align:center;"><div style="font-size:0.68rem;color:#9ca3af;font-weight:600;text-transform:uppercase;">Productos</div><div style="font-weight:700;color:#516052;font-size:0.95rem;">{{ day.items }}</div></div>
                  </div>
                </div>
              </div>
            </div>
